  ...
  return (
    <section className="w-full bg-[#EFEFEB] flex md:gap-8 gap-5 md:h-[80vh] md:flex-row flex-col">
      <div className="flex-1 flex  sm:flex-row flex-col sm:gap-10 gap-5">
        <img src={blckStreet} alt="black street" className="w-[300px] h-[60vh] object-cover" />
        <p className="font-poppins text-[#252525] opacity-[.9] sm:text-[12px] text-[14px] leading-[30px] sm:pt-[70px] sm:pl-0 pl-6 max-w-[300px]">
      ...
      <div className="flex-1 flex md:flex-row flex-col sm:gap-0 gap-5">
        <div className="flex-1 flex sm:flex-col gap-5 md:items-center justify-center items-end sm:pt-[70px] sm:px-0 px-6">
          <img src={flower} alt="flower" className="sm:w-[220px] w-[150px] sm:h-[270px] h-[200px]"/>
          <p className="font-shippori text-center sm:text-[27px] text-[24px] text-[#252525] font-medium uppercase leading-[28px] ">
            Camera <br/> is <br/> Everyting
          </p>
        </div>
        <div className="flex items-end justify-end">
          <img src={blckChild} alt="black child" className="flex-1 w-[300px] max-w-[300px] h-[60vh] object-cover relative top-1 sm:top-0" />
        </div>
      </div>
    </section>
  )
