  ...
  return (
    <section className="w-full h-screen sm:bg-bgCat bg-bgMoon bg-cover bg-no-repeat bg-center relative">
      <div className={`${styles.padding} flex sm:flex-row flex-col sm:items-start items-end`}>
        <h2 className="flex-1 text-white text-[16px] font-poppins tracking-[3px] uppercase sm:text-start text-end">
          Relive <br className="sm:hidden block"/> your <br className="sm:block hidden"/> day, <br className="sm:hidden block"/> everyday
        </h2>
        <div className="flex-1 flex flex-col gap-1 sm:pt-[160px] pt-[90px]">
          <p className="text-white sm:font-normal font-bold font-montserrat text-[15px] leading-[40px] [word-spacing: 2px] sm:w-[510px] w-full text-justify">
