...
import { natureImages } from '../../constants/gallery'
import { bgHero } from '../../assets/HomeImg'
...
const Nature = () => {
    ...
    const imgAction = (action) => {
      let i = data.i;
      if(action === 'next-img') {
        setData({img: natureImages[i + 1], i: i + 1})
    ...
    return (
      <section className={`${styles.padding} w-full relative`}>
        ...
        <div>
          <img src={bgHero} alt="garuts" className="object-contain" data-aos="fade" data-aos-duration="2000"/>
