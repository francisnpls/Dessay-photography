  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        bg1: "url('./assets/HomeImg/bgHero.jpg')",
        bg2: "url('./assets/HomeImg/hero1.jpg')",
        bg3: "url('./assets/HomeImg/hero2.jpg')",
        bg4: "url('./assets/HomeImg/hero3.jpg')",
        bg5: "url('./assets/HomeImg/hero4.jpg')",
        bg6: "url('./assets/HomeImg/hero5.jpg')",
